...
prepend_path("PATH",                "/util/comp/intel/19/compilers_and_libraries/linux/mpi/intel64/bin")
prepend_path("LD_LIBRARY_PATH",     "/util/comp/intel/19/lib/intel64")
prepend_path("LD_LIBRARY_PATH",	    "/util/comp/intel/19/compilers_and_libraries/linux/mpi/intel64/lib")
prepend_path("LIBRARY_PATH",        "/util/comp/intel/19/lib/intel64")
prepend_path("LIBRARY_PATH",        "/util/comp/intel/19/compilers_and_libraries/linux/mpi/intel64/lib")
