...
The software is licensed free of charge to academic institutions and can be downloaded from http://www.uam.es/siesta.
]]
...
load("intel-mkl/19")
prepend_path("PATH", "/util/opt/siesta/4.1/intel/19/openmpi/4.0/bin/")
prepend_path("PATH", "/util/opt/siesta/4.1/intel/19/openmpi/4.0/bin_util/")
