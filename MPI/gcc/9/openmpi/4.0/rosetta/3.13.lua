...
compiler/gcc/9, openmpi/4.0, python/2.7 and zlib/1.2
...
setenv("ROSETTA3", "/util/opt/BCRF/rosetta/3.13/gcc/9/openmpi/4.0/main/")
setenv("ROSETTA3_DB", "/work/HCC/BCRF/app_specific/rosetta/3.13/database/")
setenv("ROSETTA_TOOLS", "/util/opt/BCRF/rosetta/3.13/gcc/9/openmpi/4.0/main/source/tools/")
...
prepend_path("PATH","/util/opt/BCRF/rosetta/3.13/gcc/9/openmpi/4.0/main/source/bin")
prepend_path("PATH","/util/opt/BCRF/rosetta/3.13/gcc/9/openmpi/4.0/main/tools/")
prepend_path("PATH","/util/opt/BCRF/rosetta/3.13/gcc/9/openmpi/4.0/main/source/scripts/python/public/")
prepend_path("PATH","/util/opt/BCRF/rosetta/3.13/gcc/9/openmpi/4.0/main/tools/protein_tools/scripts/")
...
prepend_path("LD_LIBRARY_PATH","/util/opt/BCRF/rosetta/3.13/gcc/9/openmpi/4.0/main/source/build/src/release/linux/4.4/64/x86/gcc/9.4/mpi")
