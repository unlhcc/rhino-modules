...
prepend_path("PATH",     "/util/opt/curl/7.76/intel/19/bin")
prepend_path("LD_LIBRARY_PATH",     "/util/opt/curl/7.76/intel/19/lib")
prepend_path("MANPATH",             "/util/opt/curl/7.76/intel/19/share/man")
prepend_path("INCLUDE",             "/util/opt/curl/7.76/intel/19/include")
