...
setenv("BOOST_DIR",               "/util/opt/boost/1.70/intel/19")
setenv("Boost_DIR",               "/util/opt/boost/1.70/intel/19")
setenv("BOOST_INCLUDE",           "/util/opt/boost/1.70/intel/19/include")

-- Add boost to the LD_LIBRARY_PATH, LIBRARY_PATH
prepend_path("LD_LIBRARY_PATH",   "/util/opt/boost/1.70/intel/19/lib")
prepend_path("LIBRARY_PATH",      "/util/opt/boost/1.70/intel/19/lib")
prepend_path("CPATH",             "/util/opt/boost/1.70/intel/19/include")
