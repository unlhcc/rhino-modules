...
prepend_path("CPATH",               "/util/opt/openmpi/1.10/intel/16/include")
prepend_path("LIBRARY_PATH",        "/util/opt/openmpi/1.10/intel/16/lib")
prepend_path("PKG_CONFIG_PATH",     "/util/opt/openmpi/1.10/intel/16/lib/pkgconfig")

local mroot = os.getenv("MODULEPATH_ROOT") or "/util/opt/modulefiles"
local mdir = pathJoin(mroot,"MPI","intel","16","openmpi","1.10")
