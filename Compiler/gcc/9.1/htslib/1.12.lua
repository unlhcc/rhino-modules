...
prepend_path("PATH",              "/util/opt/htslib/1.12/gcc/9.1/bin")
prepend_path("LD_LIBRARY_PATH",   "/util/opt/htslib/1.12/gcc/9.1/lib")
prepend_path("INCLUDE",           "/util/opt/htslib/1.12/gcc/9.1/include")
prepend_path("MANPATH",		  "/util/opt/htslib/1.12/gcc/9.1/share/man")
setenv("HTSLIB", "/util/opt/htslib/1.12/gcc/9.1")
